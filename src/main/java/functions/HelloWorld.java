...
public class HelloWorld implements HttpFunction {
    ...
    private static String BQ_URL = null;
    ...
    public void service(HttpRequest request, HttpResponse response)
        ...
        BQ_URL = System.getenv("BQ_URL");
        if (BQ_URL == null) {
            BQ_URL = "Specified environment variable is not set.";
        }
        
        writer.write(BQ_URL);
        System.out.println("BQ_URL is "+BQ_URL);
...

        {
            ...
            for (String projectId : projectList) {
                ...
                try {
                    rowList = getGkeCluster(projectId);
                } catch (IOException | GeneralSecurityException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                List<Map<String, Object>> cloudSQLList = null;
                try {
                    cloudSQLList = getCloudSQLInstances(projectId);
    ...
    private static List<Map<String, Object>> getGkeCluster(String projectId)
        ...
        if (response != null && !response.isEmpty()) {
            ...
            for (Cluster cluster : response.getClusters()) {
                ...
                if (jsonObject != null && !jsonObject.isNull("releaseChannel")) {
        ...
        if (instanceList != null && !instanceList.isEmpty()) {
            ...
            for (DatabaseInstance instance : instanceList) {
                ...
                if (!hasEntry) {
                    ...
                    System.out.println("databaseJSON is ---->" + databaseJSON.toString());
                    try {
                        if (databaseJSON != null &&
                                databaseJSON.get("availableMaintenanceVersions") != null) {
                            System.out.println(
                                    "availableUpdates-----" + databaseJSON.get("availableMaintenanceVersions"));
                            String availableUpdates = databaseJSON.get("availableMaintenanceVersions").toString();
                            rowContent.put("AvailableUpdates", availableUpdates);
                        }
    ...
    // public static SQLAdmin createSqlAdminService() throws IOException,
